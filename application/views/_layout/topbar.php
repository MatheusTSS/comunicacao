<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #4e4de5;">
	<!-- Navbar Brand-->
	<a class="navbar-brand ps-3" style="color: #fff;" href="<?=base_url()?>"><?=APP_NAME?></a>
	<!-- Sidebar Toggle-->
	<button style="color: #fff;" class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
	<!-- Navbar Search-->
